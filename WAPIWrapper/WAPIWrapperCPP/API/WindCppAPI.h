#ifndef _WINDCPPAPI_H
#define _WINDCPPAPI_H

#include <windows.h>
#include <comutil.h>

#ifdef WINDCPPAPI_EXPORTS
#define WINDCPPAPI_API __declspec(dllexport)
#else
#define WINDCPPAPI_API __declspec(dllimport)
#endif
...
//接口类
class WINDCPPAPI_API WindCppAPI {
public:
